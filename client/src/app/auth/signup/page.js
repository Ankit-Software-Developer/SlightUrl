...
export default function SignupPage() {
  ...
  const benefits = [
    {
      ...
      title: "Start Free",
      description: "No credit card required. Full access from day one.",
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Monetize Links",
      description: "Earn revenue through smart ad placements.",
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: "Premium Features",
      description: "Access advanced analytics and custom domains.",
    },
    {
  ...
  const plans = [
    {
      name: "Free",
      price: "$0",
      features: ["Basic Analytics", "Dashboard Ads", "100 Links/Month"],
    },
    {
      name: "Pro",
      price: "$9",
      features: ["Advanced Analytics", "Reduced Ads", "Custom Domains"],
    },
    {
      name: "Business",
      price: "$29",
  ...
  const passwordRequirements = [
    { text: "At least 8 characters", meets: formData.password.length >= 8 },
    {
    ...
    { text: "Contains number", meets: /\d/.test(formData.password) },
    {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="hidden lg:flex flex-col bg-gradient-to-br from-purple-600 via-pink-600 to-rose-600 p-8 md:p-12 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10 flex-1">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Join Thousands of
                <span className="block mt-2">Successful Marketers</span>
              </h1>

              <p className="text-xl text-white/90 mb-10">
                Create your account and start shortening, tracking, and
                monetizing your links in minutes. No credit card required.
              </p>
                    ...
                    <div key={index} className="text-center">
                      ...
                      <ul className="space-y-1">
                        {plan.features.map((feature, fIndex) => (
                          <li key={fIndex} className="text-sm text-white/70">
                            {feature}
                          </li>
                        ))}
                      </ul>
              ...
              {/* <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-white/70">Setup Fee</div>
                  </div>
                </div>
              </div> */}
            </motion.div>
          ...
          <div className="w-full max-w-md">
            ...
            >
                  ...
                  <div>
                    ...
                    <div className="mt-3">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-400">
                          {passwordRequirements.filter((r) => r.meets).length}/5
                        </span>
                      </div>
                      <div className="h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(passwordRequirements.filter((r) => r.meets).length / 5) * 100}%`,
                          }}
                        />
                      </div>
              ...
              <div className="lg:hidden mt-8 grid grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center">
                  <div className="text-pink-600 dark:text-pink-400 text-2xl mb-2">
                    💰
                  </div>
